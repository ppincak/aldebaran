...
cp ../../../aldebaran-auth-micro/aldebaran-auth-server/build/libs/aldebaran-auth-server-1.0-SNAPSHOT.jar ./docker/aldebaran-auth
...
cp ../../../aldebaran-orders-micro/aldebaran-order-server/build/libs/aldebaran-order-server-1.0-SNAPSHOT.jar ./docker/aldebaran-order
